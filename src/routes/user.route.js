...
import { handleUserProfile, handleUserProfileById, handleLikeUser, handleUnlikeUser, handleUpdateProfile, handleSearchUsers } from "../controllers/user.controller.js";
import { verifyAccessToken } from "../middlewares/auth.middleware.js";

const route = express.Router();

route.get("/", verifyAccessToken, handleUserProfile);
route.get("/search", verifyAccessToken, handleSearchUsers);
